...
export default function EditClientPage() {
  ...
  const fetchClientAndCompany = async () => {
    try {
      ...
      if (company) {
        ...
        setClientData({
          first_name: clientDataFromDB.first_name || '',
          last_name: clientDataFromDB.last_name || '',
          company_name: clientDataFromDB.company_name || '',
          phone: clientDataFromDB.phone || '',
          email: clientDataFromDB.email || '',
          property_address: clientDataFromDB.property_address || ''
        })
      } else {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showSuccess(`Client ${clientData.first_name} ${clientData.last_name} updated successfully!`)
  ...
  if (error && !clientData.first_name) {
    return (
      <ProtectedRoute>
        <div className="flex h-screen bg-gray-50">
          <Sidebar />
